...
Select School.SchoolName, Person.FirstName, Person.LastName, Category.CategoryDescription from Person join School on School.SchoolID=Person.SchooID join Category on Category.CategoryID=Person.CategoryID where Person.CategoryID in(1,2,3) AND Person.SchooID=3
